...
- [architecture.md](architecture.md): the authoritative evolving architecture for Cortex as the Remram knowledge authority layer
...
Update `architecture.md` in place as new design inputs arrive. Do not create parallel architecture drafts.
