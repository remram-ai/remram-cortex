...
This is the umbrella acceptance test for the MVP. Detailed product-level regression plans live under [../../product/](../../product/README.md).
...
### 2.10 Product Detail Documents

- [01 OpenSearch Service](../../product/dependencies/opensearch-service/regression-plan.md)
- [02 Git Service](../../product/dependencies/git-service/regression-plan.md)
- [03 Artifact Storage](../../product/capabilities/artifact-storage/regression-plan.md)
- [04 Git Provider](../../product/capabilities/git-provider/regression-plan.md)
- [05 Google Drive Provider](../../product/capabilities/google-drive-provider/regression-plan.md)
- [06 Artifact Intake](../../product/capabilities/artifact-intake/regression-plan.md)
- [07 Knowledge Extraction](../../product/capabilities/knowledge-extraction/regression-plan.md)
- [08 Quick Capture](../../product/capabilities/quick-capture/regression-plan.md)
- [09 Retrieval](../../product/capabilities/retrieval/regression-plan.md)
- [10 Chat Injection](../../product/capabilities/chat-injection/regression-plan.md)
- [11 Chat Interface](../../product/capabilities/chat-interface/regression-plan.md)
...
Store project-level acceptance and HAT records under:
